...
class spamer:
	def main(self):
		...
		parser = argparse.ArgumentParser(prog='spammer',)
		parser.add_argument('phonenum', metavar='phone', help='66812345678')
		...
		print(showstatus(wrapsbrace('info', True) + ('Sending SMS to: +{}').format(_phone)))
		print('Ctrl+Z.')
		i = 1
		iteration = 0
		while i < 2:
